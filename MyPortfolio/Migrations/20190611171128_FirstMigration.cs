        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountryId = table.Column<int>(nullable: false),
                    Name = table.Column<string>(maxLength: 30, nullable: false),
                    Ticker = table.Column<string>(maxLength: 6, nullable: false),
                    SectorId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAgencies", x => x.UserAgencyId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuyOrSell = table.Column<bool>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_UserAgencies_UserAgencyId",
                        column: x => x.UserAgencyId,
                        principalTable: "UserAgencies",
                        principalColumn: "UserAgencyId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.InsertData(
                table: "Stocks",
                columns: new[] { "StockId", "CountryId", "Name", "SectorId", "Ticker" },
                values: new object[] { 1, 1, "Bank of America co-op", 1, "BAC" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_UserAgencyId",
                table: "Transactions",
                column: "UserAgencyId");
